organizeLevels = function(pof.levels, uft.levels, sub.levels)
{
...
#   sub.levels = subs.levels
  ...
  levels = list(MULTISTRAT = mstrat, LSE=lse, LSD = lsd, ED = ed, MN = mn, MF = mf)
  names(levels) = c("MultiStrat", "Long/Short Equity", "Long/Short Debt", "Event Driven", "Market Neutral", "Managed Futures")
