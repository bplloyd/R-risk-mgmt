...
sub.stats_rel = riskStats_relative(rets, width = 63, irWidth = 63)
sub.volContrib = reportVolatilityContribution(id = getSubID(name), name = name)
...
library(XLConnect)
filename = "C:\\Users\\blloyd.HF\\Documents\\GitHub\\R-risk-mgmt\\Risk Reports\\Templates\\Risk_Template_CURRENT_TEST.xlsx"
newfile = paste0("C:\\Users\\blloyd.HF\\Documents\\GitHub\\R-risk-mgmt\\Risk Reports\\Reports\\", 
                 name, 
                 "_Risk_",
                 asOfDate,
                 ".xlsx")
