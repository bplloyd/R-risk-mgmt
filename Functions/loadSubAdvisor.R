loadSubAdvisor = function(sub){
  ...
  require(xts)
  require(data.table)
  qry = "select * from v_Sub_Returns_Daily_v4 AS v where v.Name IS NOT NULL"
  qry = paste(qry, " AND v.Name = ", sub, sep = " ")
  ...
  qry24 = paste(qry24, " AND s.Abbreviation = ", sub, sep = " ")
